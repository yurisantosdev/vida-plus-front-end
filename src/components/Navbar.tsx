...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="bg-black rounded-2xl mt-3">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <DisclosureButton className="cursor-pointer group relative inline-flex items-center justify-center rounded-2xl p-2 text-gray-400 hover:bg-gray-900 hover:text-white focus:ring-2 focus:ring-white focus:outline-hidden focus:ring-inset">
              ...
              <MenuItems
                ...
                <MenuItem>
                  <div
                    ...
                    className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-2xl flex justify-start items-center gap-3">
                ...
                <MenuItem>
                  <div
                    ...
                    className="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-2xl flex justify-start items-center gap-2">
                    <SignOut size={20} className="text-black" />
                    <p>Sair</p>
                  </div>
                </MenuItem>
              </MenuItems>
              ...
              <div
                ...
                className={classNames(
                  isActive
                    ? 'bg-gray-800 text-white'
                    : 'text-gray-300 hover:bg-gray-900 hover:text-white',
                  'block rounded-2xl px-3 py-2 text-base font-medium select-none cursor-pointer'
                )}>
                <div className="flex justify-start items-center gap-3">
                  {item.icon}
                  {item.name}
